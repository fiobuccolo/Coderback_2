...
/* registro y log in: 
login redireccion a la vista de productos
agregar un msj de bienvenidad ocn los datos del usuario
- agregar un sistema de roles: 
si agregamos adminCoder@coder.comy contraseña adminCod3r123 --admin 
resto rol usuario
